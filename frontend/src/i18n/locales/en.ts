  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        expiresAtHint: 'Leave empty for no expiration. Expired groups are automatically paused.'
      },
    ...
    subscriptions: {
      ...
      form: {
        ...
        expiresAt: 'Final expiration time'
      },
      selectUser: 'Select a user',
      selectGroup: 'Select a subscription group',
      groupHint: 'Only groups with subscription billing type are shown',
      validityHint: 'Assign by day count; final expiration time overrides days when set',
      expiresAtHint: 'Alternatively choose the final expiration time; it must be in the future',
      adjustingFor: 'Adjusting subscription for',
      currentExpiration: 'Current expiration',
      adjustDaysPlaceholder: 'Positive to extend, negative to shorten',
      adjustHint: 'Enter positive days to extend, negative days to shorten, or set the final expiration time directly',
      adjustExpiresAtHint: 'Directly set the final expiration time; it must be in the future',
      assign: 'Assign',
      assigning: 'Assigning...',
      adjust: 'Adjust',
      adjusting: 'Adjusting...',
      ...
      validityDaysRequired: 'Please enter a valid number of days (at least 1) or final expiration time',
      expiresAtRequired: 'Please choose the final expiration time',
      expiresAtMustBeFuture: 'Final expiration time must be in the future',
      adjustInputRequired: 'Please enter adjustment days or final expiration time',
      adjustInputExclusive: 'Adjustment days and final expiration time cannot both be set',
      revokeConfirm:
